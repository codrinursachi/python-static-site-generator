...
def markdown_to_blocks(markdown):
    lines_in_markdown = markdown.split("\n\n")
    lines_in_markdown = [line.strip() for line in lines_in_markdown]
    lines_in_markdown = [line for line in lines_in_markdown if line != ""]
    return lines_in_markdown
